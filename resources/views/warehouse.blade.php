            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-outline-success" data-toggle="modal"
                            data-article_category_id="{{$val->article_category_id}}" data-id="{{$val->id}}"
                            type="button" onClick="triggerModel('{{$val->article_category_id}}', '{{$val->id}}')"
                            data-target="#modal-update">Update
                    </button>
                </td>
