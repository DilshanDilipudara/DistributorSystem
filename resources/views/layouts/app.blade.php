                        ...
                        @if(Auth::user()->role == "admin" || Auth::user()->role == "manager"  )
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    ...
                                    <a class="dropdown-item" href="{{ url('/transportExpenses') }}">Transport
                                        Expenses</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <a class="dropdown-item" href="{{ url('/pending_order_summery') }}">Pending Order
                                        Summery</a>
                                    <a class="dropdown-item" href="{{ url('/deliver_pending') }}">Deliver Pending</a>
                                    <a class="dropdown-item" href="{{ route('view-to-be-collected') }}">To Be Collected </a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink"
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <a class="dropdown-item" href="{{ url('/month_artical_sales_graph') }}">Monthly
                                        Artical </a>
                                    <a class="dropdown-item" href="{{ url('/year_artical_sale_graph') }}">Yearly
                                        Artical </a>
                                    <a class="dropdown-item" href="{{ url('/month_artical_category_graph') }}">Monthly
                                        Artical Category </a>
                                    <a class="dropdown-item" href="{{ url('/year_artical_category_graph') }}">Yearly
                                        Artical Category</a>
                                </div>
                            </li>
                            <li class="nav-item active">
