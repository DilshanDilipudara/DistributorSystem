...
<head>
    ...
    <link rel="stylesheet" href="/css/pending-order-summery.css">
    <title>Quick</title>
</head>
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand text-primary font-weight-bold" href="#" style="font-size: 40px !important;">Pending order summery</a>
  ...
  <section style="overflow-x: auto !important;" class="mt-4 ml-sm-2 mr-sm-2">
    <div class ="sales_list3">
      ...
      <div class="sales_list1">
        ...
        <div class="sales_list2 bg-secondary p-1 pt-2">Quantity</div>
        <div class="sales_list2 bg-secondary p-1 pt-2">Total</div>
        <div class="sales_list2 bg-secondary p-1 pt-2">Free offer</div>
        <div class="sales_list2 bg-secondary p-1 pt-2">Total Quantity</div>
      ...
      <div class="sales_list1">
        <div class="sales_list2 bg-success p-1 pt-2">&#160;</div>
        <div class="sales_list2 bg-success p-1 pt-2">&#160;</div>
        <div class="sales_list2 bg-success p-1 pt-2">&#160;</div>
        <div class="sales_list2 bg-success p-1 pt-2">&#160;</div>
        <div class="sales_list2 bg-success p-1 pt-2 text-right align-bottom" ><span class="p-2" style="font-size: 30px;font-weight: 600;color: #fff;">Total</span></div>
        <div class="sales_list2 p-1 pt-2 bg-success">
          <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input placeholder">
        </div>
        <div class="sales_list2 p-1 pt-2 bg-success">
          <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input placeholder">
