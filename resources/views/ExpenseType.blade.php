...
@section('content')
<br>
<h2 class="col-md-12 text-center"> Expense Type</h2>
<br>
<div class="container">
  <form action="/addexpensetype" method="post">
    @csrf
    <div class="form-group row">
      <label for="inputmetrics" class="col-sm-2 col-form-label">Expense Name</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" name="name" id="ex_id" placeholder="Fuel">
      </div>
    </div>
    ...
    <tbody>
      ...
      <tr>
        ...
        @if($val->isActive == true)
          <td><a href="/deleteexpensetype/{{$val->id}}" class="btn btn-outline-danger">Delete</a></td>
        @else
           <td><a href="/activeexpensetype/{{$val->id}}" class="btn btn-outline-primary">Active</a></td>
        @endif
      </tr>
      @endforeach
    </tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="" method="post" action="/updateexpensetype" enctype="multipart/form-data">
          {{ csrf_field() }}

          <div class="form-group">
            <label for="" class="col-form-label">Expense Name:</label>
